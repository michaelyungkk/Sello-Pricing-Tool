    ...
    const handleRestore = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = async (event) => {
            try {
                ...
                const currentThresholds = getThresholdConfig(); // This will now get the newly saved thresholds
