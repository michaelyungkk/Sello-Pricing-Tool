    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col overflow-hidden">
        ...
        <div className="p-6 flex-1 overflow-y-auto">
          <div className="bg-theme-10 border border-indigo-100 rounded-lg p-4 mb-6">
                ...
                <div className="col-span-4 flex items-center justify-center gap-2">
                   <div className="relative w-24">
                    <input
                      ...
                      className="w-full pl-8 pr-3 py-1.5 text-right border border-gray-300 rounded-md focus:ring-2 focus:ring-theme focus:border-theme text-sm font-mono"
                    />
                ...
                <div className="col-span-4 flex items-center justify-center gap-2">
                  <div className="relative w-24">
                    <input
                      ...
                      className="w-full pl-3 pr-7 py-1.5 text-right border border-gray-300 rounded-md focus:ring-2 focus:ring-theme focus:border-theme text-sm font-mono"
                    />
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
          ...
          <button 
            onClick={handleSave}
            className="px-6 py-2 bg-theme hover:bg-theme text-white font-medium rounded-lg shadow-md shadow-indigo-200 transition-all flex items-center gap-2"
          >
