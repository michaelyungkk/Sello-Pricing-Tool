...
export const QuickUploadMenu: React.FC<QuickUploadMenuProps> = ({ themeColor, actions, disabled }) => {
    ...
    return (
        <div className="relative z-50" ref={menuRef}>
            <button
                ...
                disabled={disabled}
                className={`flex items-center gap-2 px-4 py-2 text-white rounded-lg shadow-md transition-all font-medium ${disabled ? 'opacity-40 cursor-not-allowed pointer-events-none' : 'hover:opacity-90'}`}
