            ...
            <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                ...
                {hasTransactions && (
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={() => onScrollToSection('analysis')} className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs font-medium text-gray-600 hover:border-indigo-300 hover:text-indigo-600 hover:shadow-sm transition-all flex items-center gap-1.5">
                            <BarChart2 className="w-3.5 h-3.5" /> Distribution
                        </button>
                        <button onClick={() => onScrollToSection('pricing')} className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs font-medium text-gray-600 hover:border-indigo-300 hover:text-indigo-600 hover:shadow-sm transition-all flex items-center gap-1.5">
                            <History className="w-3.5 h-3.5" /> Pricing
                        </button>
                        <button onClick={() => onScrollToSection('ledger')} className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs font-medium text-gray-600 hover:border-indigo-300 hover:text-indigo-600 hover:shadow-sm transition-all flex items-center gap-1.5">
                            <FileText className="w-3.5 h-3.5" /> Ledger
                        </button>
                        <button onClick={() => onScrollToSection('refunds')} className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs font-medium text-gray-600 hover:border-indigo-300 hover:text-indigo-600 hover:shadow-sm transition-all flex items-center gap-1.5">
